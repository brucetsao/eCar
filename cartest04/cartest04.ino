  ...
  //----- dip switch set  ----
    pinMode(dip1,INPUT);   // init dip switch set pin for read
  ...
  void setup()
  {
    ...
    { 
      CMD = 1 ;  // for IR control
      Serial.println("for IR control");
    }
    else
    {
      CMD = 0  ;// for Bluetooth control
      Serial.println("for Bluetooth control");
    }  
